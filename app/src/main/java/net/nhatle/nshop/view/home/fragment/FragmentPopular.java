...
public class FragmentPopular extends Fragment implements IProductListView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        productRecyclerViewAdapter = new ProductRecyclerViewAdapter(getActivity(), productList, R.layout.custom_recycler_view_fragment_product_2_column);
        ...
        homeProductPresenter.getPopularProductList();
        return view;
    }
