...
//import net.nhatle.nshop.adapter.Grid4ColumnProductAdapter;
...
public class FragmentInterest extends Fragment implements IProductListView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerViewInterest);
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getContext() ,4);
        productRecyclerViewAdapter = new ProductRecyclerViewAdapter(getContext(), productList, R.layout.custom_recycler_view_fragment_product_4_column);
        ...
        homeProductPresenter.getRandomProductList();
        return view;
    }
